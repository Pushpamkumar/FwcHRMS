...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-[#090514] border-r border-white/[0.05] h-screen flex flex-col justify-between select-none shrink-0 overflow-y-auto">
      {/* Brand Header */}
      <div>
        <div className="p-6 flex items-center space-x-3 border-b border-white/[0.05] sidebar-brand-header">
